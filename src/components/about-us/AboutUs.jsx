...
export function AboutUs() {
    return (
        <>
            <div className="about-us-general">
                <div className="about-us-container">
                    <div className="title-about-us-container">
                        <div>
                            <h3>Sobre nós</h3>
                            <h2>Somos o <span>Pix do Milhão</span></h2>
                        </div>
                    </div>
                    <div className="text-about-us-container">
                        <p>O <span>PIX DO MILHÃO</span> é uma iniciativa inovadora que, semanalmente, transforma vidas e realiza sonhos. Nosso compromisso é oferecer conhecimento por meio dos nossos e-books e, com isso, dar a você a chance de concorrer a diversos prêmios.</p>
